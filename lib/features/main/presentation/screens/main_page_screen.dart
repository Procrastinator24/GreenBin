        ...
        return Scaffold(
          appBar: AppBar(
            leading: IconButton(
              ...
              style: IconButton.styleFrom(backgroundColor: Color(0xffDEEFF3)),
              onPressed: () {
                Navigator.push(
                  context,
            ...
            title: Text(state.user.name ?? 'Загрузка...'), //заглушка
          ),
          body: Padding(
              ...
              child: Column(
                ...
                children: [
                  carousel.CarouselSlider(
                    items: [
                      _buildCarouselItem(
                        'Какой пластик поддается переработке?',
                      ),
                      _buildCarouselItem(
                        'Какой пластик поддается переработке?',
                      ),
